...
import Mouse
import Random (Seed, generate, initialSeed, int)
import Signal (Signal, (<~), (~), foldp, map, sampleOn)
import Text (color, fromString, height, leftAligned, monospace)
import Time (Time, every, fps, inSeconds)
